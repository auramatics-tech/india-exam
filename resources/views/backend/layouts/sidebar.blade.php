    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
            ...
            <ul class="menu-nav">
                ...
                <li class="su_toogle_Categories"><a class="accordion-heading su_a_decoration su_color_Categories" data-toggle="collapse" data-target="#categories_list"><i class="fa-solid fa-certificate su_icon_Categories_main"></i>Categories</a>
                    <ul class="nav nav-list collapse" id="categories_list">
                        {!!navbar()!!}
                    </ul>
                </li>
                
                <li class="menu-item  @if (Route::is('admin.add_mutliple_questions')=='admin.add_mutliple_questions'
                    ) menu-item-active @endif" aria-haspopup="true">
                    <a href="{{route('admin.add_mutliple_questions')}}" class="menu-link">
                        <span class="svg-icon menu-icon">
                            <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <span class="menu-text">Add multiple Questions</span>
                    </a>
                </li>
                ...
                <li class="menu-item  @if (Route::is('admin.blogs')=='admin.blogs'
                    ) menu-item-active @endif" aria-haspopup="true">
                ...
                <li class="menu-item  @if (Route::is('admin.blog_category_list')=='admin.blog_category_list'
                    ) menu-item-active @endif" aria-haspopup="true">
                    <a href="{{route('admin.blog_category_list')}}" class="menu-link">
                        <span class="svg-icon menu-icon">
                            <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <span class="menu-text">Blog Category Management</span>
                    </a>
                </li>
                <li class="menu-item  @if (Route::is('admin.announcements')=='admin.announcements'
                    ) menu-item-active @endif" aria-haspopup="true">
                ...
                <li class="menu-item  @if (Route::is('mock.category_data')=='mock.category_data'
                    ...
                    <a href="{{route('mock.category_data')}}" class="menu-link">
                        ...
                        <span class="menu-text">Mock Test Categories</span>
                    </a>
                </li>
                ...
                <li class="menu-item  @if (Route::is('admin.privacy')=='admin.privacy'
                    ) menu-item-active @endif" aria-haspopup="true">
                ...
                <li class="menu-item  @if (Route::is('admin.terms')=='admin.terms'
                    ) menu-item-active @endif" aria-haspopup="true">
