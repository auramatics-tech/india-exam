        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-1 ml-3">Subcategories of {{ isset($categories[0]) ? $categories[0]name : '' }}</h5>
                    <!--end::Page Title-->
                </div>
                <!--end::Page Heading-->
            </div>
            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Subcategories
                            <span class="d-block text-muted pt-2 font-size-sm">Edit Subcategories details and delete
                                Subcategories</span>
                        </h3>
                    </div>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-4 my-2 my-md-0">
                                        <form method="get" action="" class="d-flex text-right" id="search">
                                            ...
                                            <div class="mx-2">
                                                <a> <button href="{{route('admin.get_sub_cat')}}" type="submit" class="btn btn-success Reset_btn"> Reset</button></a>
                                            </div>
                                        </form>
                                    </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('admin.show_topics',$category->id)}}"
                                        style="text-decoration: none; color:green;">
                                ...
                                <div class="form-check form-switch">
                                        <input class="form-check-input act" type="checkbox" role="switch" id="flexSwitchCheckChecked" @if(isset($category->active) && $category->active == '1') data-status="0" @else data-status="1" @endif @if(isset($category->active) && $category->active == '1') checked @endif value="{{ $category->id }}" >
