        ...
        <nav class="container navbar navbar-expand-custom navbar_padding1">
            ...
            <div class="navbar-collapse su_postion si_overflow_style" style="justify-content: left; display: none;" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    @if ($key < 4) <li class="nav-item @if((isset(request()->category1) && request()->category1 == $val->slug)) active @endif">
                        ...
                        <div class="dropdown su_postion su_more_nav">
                            <a class="dropdown-toggle su_navitem_clr2" href="#" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false"> More
                            </a>
                            <ul class="dropdown-menu su_drop_width2" aria-labelledby="dropdownMenuLink">
                                @foreach (get_all_category() as $key => $val)
                                @if ($key > 4)
                                <li><a id="nav_cat{{ isset(request()->category1) ? request()->category1 : '' }}" class="dropdown-item su_more" @if (isset(request()->category1) && !in_array(request()->category1, $drop_act)) data-id="1" @else data-id="0" @endif
